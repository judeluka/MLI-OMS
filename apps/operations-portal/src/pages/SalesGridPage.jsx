...
const EditableCell = React.memo(({ value, type, field, groupId, onSave, onCancel, isEditing, onEdit, align = 'center' }) => {
  ...
  if (!isEditing) {
    return (
      <div 
        className={`editable-cell ${align === 'left' ? 'editable-cell-left' : ''}`}
        onClick={onEdit}
        title="Click to edit"
      >
  ...
  return (
    <div className={`cell-content ${align === 'left' ? 'cell-content-left' : ''}`}>
      <input
        ref={inputRef}
        type={type}
        value={editValue || ''}
      ...
      />
      {isLoading && (
        <svg className="animate-spin h-4 w-4 text-blue-600 flex-shrink-0 ml-2" fill="none" viewBox="0 0 24 24">
...
function SalesGridPage({ onLogout }) {
  ...
  const salesGridStyles = `
    ...
    /* Fixed column widths - increased for better header accommodation */
    .w-col-1 { width: 70px; min-width: 70px; max-width: 70px; }      /* ID */
    .w-col-2 { width: 180px; min-width: 180px; max-width: 180px; }   /* Group Name */
    .w-col-3 { width: 140px; min-width: 140px; max-width: 140px; }   /* Agency */
    .w-col-4 { width: 120px; min-width: 120px; max-width: 120px; }   /* Arrival */
    .w-col-5 { width: 120px; min-width: 120px; max-width: 120px; }   /* Departure */
    .w-col-6 { width: 90px; min-width: 90px; max-width: 90px; }      /* Leaders */
    .w-col-7 { width: 90px; min-width: 90px; max-width: 90px; }      /* Students */
    .w-col-8 { width: 80px; min-width: 80px; max-width: 80px; }      /* Total */
    .w-col-9 { width: 90px; min-width: 90px; max-width: 90px; }      /* Actions */
    ...
    /* Sticky column positioning - updated cumulative widths */
    .sticky-col-1 { left: 0px; }                    /* 0 */
    .sticky-col-2 { left: 70px; }                   /* 70 */
    .sticky-col-3 { left: 250px; }                  /* 70 + 180 = 250 */
    .sticky-col-4 { left: 390px; }                  /* 250 + 140 = 390 */
    .sticky-col-5 { left: 510px; }                  /* 390 + 120 = 510 */
    .sticky-col-6 { left: 630px; }                  /* 510 + 120 = 630 */
    .sticky-col-7 { left: 720px; }                  /* 630 + 90 = 720 */
    .sticky-col-8 { left: 810px; }                  /* 720 + 90 = 810 */
    .sticky-col-9 { left: 890px; }                  /* 810 + 80 = 890 */
    
    /* Header text styling - prevent wrapping and ensure proper display */
    .sales-grid-table th {
      white-space: nowrap;
      overflow: hidden;
    ...
    /* Cell content styling - proper alignment and spacing */
    .sales-grid-table td {
      padding: 8px;
      vertical-align: middle;
      box-sizing: border-box;
    ...
    /* Date column headers - allow controlled wrapping for better fit */
    .date-header {
      white-space: normal;
      line-height: 1.2;
      padding: 8px 4px;
    ...
    /* Prevent column compression during scroll */
    ...
    .sales-grid-table {
      min-width: 1320px; /* Minimum width to prevent compression - increased for agency column */
    }
    
    /* Header sort indicator positioning */
    .sort-header {
      display: flex;
      align-items: center;
      justify-content: center;
              ...
              <table className="min-w-full divide-y divide-slate-200 sales-grid-table">
                <thead className="bg-slate-50">
                  <tr>
                    {/* Fixed columns */}
                    <th 
                      className="sticky sticky-col-1 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-1"
                      onClick={() => handleSort('id')}
                    >
                      <div className="sort-header text-xs font-medium text-slate-500 uppercase tracking-wider">
                        ID
                        <SortIndicator column="id" sortColumn={sortColumn} sortDirection={sortDirection} />
                      </div>
                    </th>
                    <th 
                      className="sticky sticky-col-2 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-2"
                      onClick={() => handleSort('groupName')}
                    >
                      <div className="sort-header sort-header-left text-xs font-medium text-slate-500 uppercase tracking-wider">
                        Group Name
                        <SortIndicator column="groupName" sortColumn={sortColumn} sortDirection={sortDirection} />
                      </div>
                    </th>
                    <th 
                      className="sticky sticky-col-3 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-3"
                      onClick={() => handleSort('agency')}
                    >
                      <div className="sort-header text-xs font-medium text-slate-500 uppercase tracking-wider">
                        Agency
                        <SortIndicator column="agency" sortColumn={sortColumn} sortDirection={sortDirection} />
                      </div>
                    </th>
                    <th 
                      className="sticky sticky-col-4 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-4"
                    ...
                    <th 
                      className="sticky sticky-col-5 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-5"
                    ...
                    <th 
                      className="sticky sticky-col-6 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-6"
                    ...
                    <th 
                      className="sticky sticky-col-7 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-7"
                    ...
                    <th 
                      className="sticky sticky-col-8 z-10 bg-slate-50 border-r-2 border-blue-300 cursor-pointer hover:bg-slate-100 select-none w-col-8"
                    ...
                    <th className="sticky sticky-col-9 z-10 bg-slate-50 border-r-2 border-blue-300 w-col-9">
                      <div className="sort-header text-xs font-medium text-slate-500 uppercase tracking-wider">
                        Actions
                      </div>
                    </th>
                ...
                <tbody className="bg-white divide-y divide-slate-200">
                  ...
                  <tr className="bg-blue-100 border-b-2 border-blue-300">
                    <td className="sticky sticky-col-1 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-1">
                      <div className="cell-content font-bold text-slate-900">
                        TOTALS
                      </div>
                    </td>
                    <td className="sticky sticky-col-2 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-2">
                      <div className="cell-content-left font-bold text-slate-900">
                        {sortedGroups.length} groups
                      </div>
                    </td>
                    <td className="sticky sticky-col-3 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-3">
                      <div className="cell-content font-bold text-slate-900">
                        -
                      </div>
                    </td>
                    <td className="sticky sticky-col-4 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-4">
                      <div className="cell-content font-bold text-slate-900">
                        -
                      </div>
                    </td>
                    <td className="sticky sticky-col-5 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-5">
                      <div className="cell-content font-bold text-slate-900">
                        -
                      </div>
                    </td>
                    <td className="sticky sticky-col-6 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-6">
                      <div className="cell-content font-bold text-slate-900">
                        {sortedGroups.reduce((sum, group) => sum + group.numberOfLeaders, 0)}
                      </div>
                    </td>
                    <td className="sticky sticky-col-7 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-7">
                      <div className="cell-content font-bold text-slate-900">
                        {sortedGroups.reduce((sum, group) => sum + group.numberOfStudents, 0)}
                      </div>
                    </td>
                    <td className="sticky sticky-col-8 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-8">
                      <div className="cell-content font-bold text-slate-900">
                        {sortedGroups.reduce((sum, group) => sum + group.totalBeds, 0)}
                      </div>
                    </td>
                    <td className="sticky sticky-col-9 z-10 bg-blue-100 border-r-2 border-blue-300 w-col-9">
                  ...
                  {sortedGroups.map((group, index) => (
                    <tr key={group.id} className={index % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                      <td className="sticky sticky-col-1 z-10 bg-inherit border-r-2 border-blue-300 w-col-1">
                        <div className="cell-content text-slate-900">
                          {group.id}
                        </div>
                      </td>
                      <td className="sticky sticky-col-2 z-10 bg-inherit border-r-2 border-blue-300 w-col-2">
                        <EditableCell
                      ...
                      <td className="sticky sticky-col-3 z-10 bg-inherit border-r-2 border-blue-300 w-col-3">
                        <EditableCell
                          value={group.agency}
                          type="text"
                          field="agency"
                          ...
                          onSave={handleCellSave}
                          onCancel={handleCellCancel}
                          isEditing={editingCell?.groupId === group.id && editingCell?.field === 'agency'}
                          onEdit={() => handleCellEdit(group.id, 'agency')}
                          align="left"
                        />
                      </td>
                      <td className="sticky sticky-col-4 z-10 bg-inherit border-r-2 border-blue-300 w-col-4">
                        <EditableCell
                      ...
                      <td className="sticky sticky-col-5 z-10 bg-inherit border-r-2 border-blue-300 w-col-5">
                        <EditableCell
                      ...
                      <td className="sticky sticky-col-6 z-10 bg-inherit border-r-2 border-blue-300 w-col-6">
                        <EditableCell
                      ...
                      <td className="sticky sticky-col-7 z-10 bg-inherit border-r-2 border-blue-300 w-col-7">
                        <EditableCell
                      ...
                      <td className="sticky sticky-col-8 z-10 bg-inherit border-r-2 border-blue-300 w-col-8">
                        <div className="cell-content font-semibold text-slate-900 bg-blue-50 rounded">
                          {group.totalBeds}
                        </div>
                      </td>
                      <td className="sticky sticky-col-9 z-10 bg-inherit border-r-2 border-blue-300 w-col-9">
